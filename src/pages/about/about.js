  ...
  return (
    <div className='main'>
        ...
        <div className='row'>
          <div className='card_1'>
            <div className='about_coinbase_content'>
              ...
              {/* <!--end of about coinbase icons--> */}{' '}
            </div>{' '}
            {/* <!--End of about coin base content--> */}{' '}
          </div>{' '}
          {/* <!--End of card--> */}{' '}
        </div>{' '}
        {/* <!--End of row--> */}{' '}
      ...
      <section className='our-history'>
        <h3> Our history </h3> <img className='ine_img' src={line} alt='line' />
        <div>
          <p style={{ color: 'rgb(99%, 45%, 61%)' }}> May 2010 </p>{' '}
          <p>
            {' '}
            Ut enim mi, mattis at sollicitudin rhoncus, rhoncus eget
            sem.Curabitur aliquam tellus eu nisl suscipit, at vestibulum ex
            rutrum.Nulla facilisi.Cras ullamcorper pellentesque orci, nec
            vestibulum nibh.uspendisse{' '}
          </p>{' '}
        </div>{' '}
        <div>
          <p style={{ color: 'rgb(99%, 45%, 61%)' }}> May 2017 </p>{' '}
          <p>
            {' '}
            Ut enim mi, mattis at sollicitudin rhoncus, rhoncus eget
            sem.Curabitur aliquam tellus eu nisl suscipit, at vestibulum ex
        ...
        <div>
          <p style={{ color: 'rgb(99%, 45%, 61%)' }}> May 2019 </p>{' '}
          <p>
            {' '}
            Ut enim mi, mattis at sollicitudin rhoncus, rhoncus eget
            sem.Curabitur aliquam tellus eu nisl suscipit, at vestibulum ex
      ...
      <section className='section2'>
        ...
        <form action='#' method='GET' className='section__form'>
          ...
          <br />
          <button className='section-button header__end-cta'>
            {' '}
            DISCOVER{' '}
          </button>{' '}
        </form>{' '}
